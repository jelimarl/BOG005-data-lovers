...
describe('sortSpells', () => {
  ...
  it('returns output', () => {
    expect(sortSpells(dataTest1, "az")).toStrictEqual(sortOutput1);
  });

  it('returns output', () => {
    expect(sortSpells(dataTest3, "az")).toStrictEqual(sortOutput1);
  });

  it('returns output', () => {
    expect(sortSpells(dataTest1, "za")).toStrictEqual(sortOutput2);
  });

  it('returns output', () => {
    expect(sortSpells(dataTest3, "za")).toStrictEqual(sortOutput2);
  });

  it('returns output', () => {
    expect(sortSpells(dataTest2, "za")).toStrictEqual(output2);
  });
});
